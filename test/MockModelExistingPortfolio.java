...
/**
 * A mock class for the Model for testing, for the use case where the
 * portfolio already exists.
 * This class implements all methods from the IModel interface.
 * The methods append strings to the model log used for testing.
 */
public class MockModelExistingPortfolio implements IModel {
  StringBuilder modelLog;

  public MockModelExistingPortfolio(StringBuilder modelLog) {
